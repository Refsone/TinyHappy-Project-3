...
const Milestone = (props) => {
  return (
    <>
      ...
      <TextArea sendMomentSucceed={props.sendMomentSucceed} textInContextArea={props.textInContextArea} textInMomentArea={props.textInMomentArea} title='DESCRIPTION' active={props.active} SendCreateMoment={props.SendCreateMoment} onChangeTextInContextArea={props.onChangeTextInContextArea} onChangeTextInMomentArea={props.onChangeTextInMomentArea} placeholder='Ajouter une description' idQuote='description' idContext='contextMilestone' />
    </>
  )
}
