...
const Milestone = (props) => {
  return (
    <>
      ...
      <TextArea title='DESCRIPTION' active={props.active} handleSendCreateMoment={props.handleClickSendCreateMoment} onChangeTextInDescriptionArea={props.onChangeTextInDescriptionArea} onChangeTextInMomentArea={props.onChangeTextInMomentArea} placeholder='Ajouter une description' idQuote='description' idContext='contextMilestone' />
    </>
  )
}
