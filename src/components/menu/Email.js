  ...
  return (
    <div className='settings-container-pwdmail'>
      ...
      <form onSubmit={handleSubmit} className='general-form-connexion' noValidate>
        ...
        <input name='user_mail' type='text' id='user_mail' value={values.email} onChange={handleChange} className={`${errors.user_mail ? 'input-email-error' : 'input-email plholder bold-12px-grey'}`} placeholder='**********' />
